 ...
 <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" target="_blank">
        <img src="../../assets/img/eneos.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="brand-text ms-1 font-weight-bold" style="font-size: 90%">
          PT. JX Nippon Oil & Energy
        </span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#pagesExamples" class="nav-link " aria-controls="pagesExamples" role="button" aria-expanded="false">
            ...
            <span class="nav-link-text ms-1">Logging Histroy</span>
          </a>
          <div class="collapse " id="pagesExamples">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item ">
                <a class="nav-link " href="/logdata">
                  <span class="sidenav-mini-icon"> Log </span>
                  <span class="sidenav-normal"> Logging Data <b class="caret"></b></span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="/osm">
                  <span class="sidenav-mini-icon"> OSM </span>
                  <span class="sidenav-normal"> On Site Monitoring <b class="caret"></b></span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="authExamples">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item ">
                <a class="nav-link " href="/drain">
                  <span class="sidenav-mini-icon"> D&E </span>
                  <span class="sidenav-normal"> Drain & Emptying<b class="caret"></b></span>
                </a>
              </li>
            </ul>
          </div>
        ...
        @hasrole('Admin')
        <li class="nav-item">
          <a data-bs-toggle="collapse" href="#authExampless" class="nav-link " aria-controls="authExampless" role="button" aria-expanded="false">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center d-flex align-items-center justify-content-center  me-2">
          ...
          <div class="collapse " id="authExampless">
            <ul class="nav ms-4 ps-3">
              <li class="nav-item ">
                <a class="nav-link " href="/user">
                  <span class="sidenav-mini-icon"> User </span>
                  <span class="sidenav-normal"> User Account<b class="caret"></b></span>
                </a>
              </li>
            </ul>
          </div>
